...
{
	JLabel lbl2=new JLabel(new ImageIcon("../Images/mnnp.jpg"));
	...
	JMenu mnuacc=new JMenu("Accounts");
	...
	JMenuItem mipack=new JMenuItem("Package",new ImageIcon("../Images/packages.png"));
	...
	JMenuItem micracc=new JMenuItem("Create Account",new ImageIcon("../Images/ca.jpg"));
	JMenuItem miupacc=new JMenuItem("Update User",new ImageIcon("../Images/update.jpg"));
	...
	public menu1()
	{
		...
		micracc.addActionListener(this);
		miupacc.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==micracc)
		{
			createuser crobj=new createuser();
		}
		if(e.getSource()==miupacc)
		{
